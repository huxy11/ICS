...
/*2 byte_opcode_table */
  ...
  /* 0x20 */	IDEXW(CR2G, mov, 4), EMPTY, IDEXW(G2CR, mov, 4), EMPTY,
  ...
  /* 0xb4 */	EMPTY, EMPTY, IDEX(mov_1bE2G, movzx), IDEXW(mov_2bE2G, movzx, 4),
  /* 0xb8 */	EMPTY, EMPTY, EMPTY, EMPTY,
  /* 0xbc */	EMPTY, EMPTY, IDEX(mov_1bE2G, movsx), IDEXW(mov_2bE2G, movsx, 4),
